...
namespace vr
{
    ...
    InstanceWrapper VulkanBuilder::CreateInstance()
	{
        ...
        for (auto& ext : InstanceExtensions)
            instBuilder.enable_extension(ext);
        for (auto& layer : InstanceLayers)
            instBuilder.enable_layer(layer);
        ...
        if (EnableDebug)
        {
            instBuilder.request_validation_layers()
                ...
                .add_debug_messenger_type((VkDebugUtilsMessageTypeFlagsEXT)(
    ...
    CommandQueues VulkanBuilder::GetQueues()
    {
        ...
        return { gQ.value(), cQ.value(), tQ.value(), pQ.value() ,
                 gI.value(), cI.value(), tI.value(), pI.value()};
    }
	...
	SwapchainBuilder::SwapchainBuilder(vk::Device dev,
    ...
    SwapchainStructs SwapchainBuilder::BuildSwapchain(vk::SwapchainKHR oldswapchain)
    {
        ...
        swapBuilder = new vkb::SwapchainBuilder(
                PhysicalDevice, 
                Device, 
                Surface,
                GraphicsQueueIndex,
